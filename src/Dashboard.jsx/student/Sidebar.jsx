...
const Sidebar = () => {
    ...
    return (
        <aside className="bg-[#4c5696] w-dashboard-md p-10 h-screen fixed top-0 bottom-0">
            <div>
                <Link to='/'><h1 className="text-2xl font-bold text-center text-white">DreamPic</h1></Link>
            </div>
            {/* <img src={logo} alt="" /> */}
            <ul className="mt-[60px] ">

                {
                    isAdmin ? <>
                        ...
                        :
                        <>
                            <li className="mt-4 "><NavLink to="/dashboard/table" className={({ isActive }) => isActive ? "d-active flex gap-2 text-[16px] items-center" : "uppercase flex gap-2 text-[16px] items-center"}><HiHome className="text-[24px]" /><span className="text-white">Table</span></NavLink></li>
